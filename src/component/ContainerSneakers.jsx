            ...
            <div className="sneakers-content grid grid-cols-[auto_1fr] grid-rows-[460px]  w-full xl:w-[1000px] ">
                <div className="container-img-sneakers w-[380px] h-full  flex flex-col md:gap-1">
                    ...
                    <div className="item-tumb w-full pt-2 px-2  flex items-center justify-between">
                            <div className="thumb-item w-[70px] rounded-lg cursor-pointer overflow-hidden h-[70px] ">
                            <img src="./images/image-product-1.jpg" alt="" className="img-item-thumb object-cover object-top w-full h-full  select-none" />
                            </div>
                            <div className="thumb-item w-[70px] rounded-lg cursor-pointer overflow-hidden h-[70px] ">
                            <img src="./images/image-product-2.jpg" alt="" className="img-item-thumb object-cover object-top w-full h-full  select-none" />
                            </div>
                            <div className="thumb-item w-[70px] rounded-lg cursor-pointer overflow-hidden h-[70px] ">
                            <img src="./images/image-product-3.jpg" alt="" className="img-item-thumb object-cover object-top w-full h-full  select-none" />
                            </div>
                            <div className="thumb-item w-[70px] rounded-lg cursor-pointer overflow-hidden h-[70px] ">
                            <img src="./images/image-product-4.jpg" alt="" className="img-item-thumb object-cover object-top w-full h-full  select-none" />
                            </div>
