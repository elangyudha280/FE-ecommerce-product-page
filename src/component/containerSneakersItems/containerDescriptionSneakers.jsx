...
const ContainerDescriptionSneakers = ()=>{
    ...
    let {setCountSneakers,numberCount,setNumberCount} = useContext(contextSneakers);
    ...
    return (
        ...
        <h2 className="title-company text-orange-400 font-[700] uppercase tracking-widest text-xs">Sneaker Company</h2>
            ...
            <div className="button-action-sneakers flex flex-col h-auto mt-5 xs:flex-row  xs:h-[50px] gap-3">
                ...
                <button onClick={()=>{setCountSneakers(numberCount)}} className="add-to-cart transition-all duration-200 active:scale-90 h-[40px] flex items-center justify-center bg-ecommerce-orange rounded-md gap-2 font-[700] text-white text-sm xs:flex-1 xs:h- shadow-[0_1em_1em_0_rgba(221,221,221,0.8)]">
